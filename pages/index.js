          ...
          {showDisconnect && (
            <div className="absolute top-full right-0 mt-2 bg-gray-800 border border-gray-600 rounded-lg shadow-xl z-50 min-w-48">
              <div className="p-3 border-b border-gray-600">
                ...
                <div className="text-gray-400 text-xs font-mono">{web3.address}</div>
              </div>
              <div className="p-2">
                <button
                  onClick={() => {
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 flex flex-col">
      <div className="relative w-full pt-6 pb-6">
        <div className="absolute top-6 right-6 z-10 flex flex-col items-end">
          ...
          <div className="mt-3 bg-gradient-to-br from-gray-800/90 to-gray-700/80 backdrop-blur-sm rounded-xl shadow-lg border border-gray-600/30 p-3">
      ...
      <div className="flex justify-center px-4 mt-32 mb-4">
