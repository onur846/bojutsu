...
function useWeb3() {
  ...
  const switchToKatana = () => {
    switchChain({ chainId: 129399 });
  };
      ...
      for (const vault of REAL_VAULTS) {
        try {
          const balanceHex = await window.ethereum.request({
            ...
            params: [{
              to: vault.address,
              data: `0x70a08231000000000000000000000000${web3.address.slice(2)}`
            }, 'latest']
          });
...
const RiskTab = () => {
  ...
  return (
    <div className="w-full max-w-4xl px-4 space-y-6">
      <div className="bg-gradient-to-br from-gray-800/90 to-gray-700/80 backdrop-blur-sm rounded-2xl p-6 border border-gray-600/30">
        <h2 className="text-3xl font-bold text-white mb-6">Impermanent Loss Calculator</h2>
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-1 justify-center items-start pb-12">
        ...
        {activeTab === 'vaults' && <VaultsTab setModal={setModal} />}
      ...
      <footer className="text-center py-6">
        <div className="flex items-center justify-center">
          <div className="bg-gradient-to-br from-gray-800/90 to-gray-700/80 backdrop-blur-sm rounded-lg border border-gray-600/30 px-4 py-2">
